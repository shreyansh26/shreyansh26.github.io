...
description: "The Capture the Flag event for Codefest'19 was hosted from 8 pm IST, 23rd August 2019 to 12 noon IST, 24th August 2019 on Hackerrank."
thumbnail: /assets/img/posts_images/codefest19/featured.png
tags: ["steganography", "web", "forensics", "reverse engineering", "ctf", "writeups"]
categories: ["Information Security"]
giscus_comments: true
related_posts: false
permalink: "post/2019-08-25_codefest19-ctf-writeups/"
featured: false
toc:
  sidebar: left
---

{% include image.liquid url="/assets/img/posts_images/codefest19/featured.png" description="" %}
...
{% include image.liquid url="/assets/img/posts_images/codefest19/1.png" description="The challenge" %}
...
The language was [Deadfish](https://esolangs.org/wiki/Deadfish). You could use an online decoder for that language.
...
{% include image.liquid url="/assets/img/posts_images/codefest19/2.png" description="The challenge" %}
...
{% include image.liquid url="/assets/img/posts_images/codefest19/3.png" description="Hex view of the image" %}
...
<script src="https://gist.github.com/shreyansh26/391d4103c8175cd3484c286d7c51dfd7.js"></script>

Run the script, and you obtain the correct file.

{% include image.liquid url="/assets/img/posts_images/codefest19/4.jpeg" description="The correct file" %}
...
{% include image.liquid url="/assets/img/posts_images/codefest19/5.jpeg" description="Challenge image" %}
...
{% include image.liquid url="/assets/img/posts_images/codefest19/6.png" %}
...
{% include image.liquid url="/assets/img/posts_images/codefest19/7.png" description="The challenge" %}
...
<script src="https://gist.github.com/shreyansh26/9f262ca29ec6bcb5c8b66e1feb95cf6e.js"></script>

The obtained image is this -

{% include image.liquid url="/assets/img/posts_images/codefest19/8.png" description="You may want to zoom in a bit"%}
...
{% include image.liquid url="/assets/img/posts_images/codefest19/9.png" description="Decompiled main function" %}


The _key_int_ and _enc_int_ are global variables. The main logic of the ELF is in the **rahasya** function.

{% include image.liquid url="/assets/img/posts_images/codefest19/10.png" description="Decompiled rahasya function" %}
...
{% include image.liquid url="/assets/img/posts_images/codefest19/11.png" description="enc_int data" %}

{% include image.liquid url="/assets/img/posts_images/codefest19/12.png" description="key_int data" %}
...
<script src="https://gist.github.com/shreyansh26/c0c225fa5daa05da85bb0534dc5438a9.js"></script>

We can use some kind of SMT solver like z3 to find the password.

<script src="https://gist.github.com/shreyansh26/bccc43909e68ddd7d219f59fc48da4c5.js"></script>
