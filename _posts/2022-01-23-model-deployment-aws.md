...
thumbnail: /assets/img/posts_images/model_deployment_aws/featured.jpg
...
{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/featured.jpg" description="" %}
...
{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/ini-streamlit.PNG" description="" %}
...
{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/ecr1.PNG" description="" %}
...
{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/lambda1.PNG" description="" %}

The container image URI can be selected from the AWS console itself.

{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/lambda2.PNG" description="" %}
...
{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/lambda3.PNG" description="" %}

The test works and gives the correct result!!

{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/lambda4.PNG" description="" %}

### 6. Create an API from the Amazon API Gateway

Make sure to make a REST API.

{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/api1.PNG" description="" %}

{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/api2.PNG" description="" %}
...
{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/api3.PNG" description="" %}

Integrate the Lambda function with the API.

{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/api4.PNG" description="" %}

Now, if you head back to the Lambda functions page, you will see that a Trigger has been added to the function.

{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/api5.PNG" description="" %}
...
{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/postman.PNG" description="" %}
...
<b> The above API URL and endpoint will not work for you. You should replace it with your own endpoint URL. </b>
...
{% include image.liquid url="/assets/img/posts_images/model_deployment_aws/fin-streamlit.PNG" description="" %}
