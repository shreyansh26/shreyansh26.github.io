...
thumbnail: /assets/img/posts_images/fast_api/featured.png
...
Now that you have the Docker image, the entire environment can be recreated on any other machine. You can push the image to DockerHub ([refer here](https://docs.docker.com/docker-hub/repos/manage/hub-images/push/)) or export as a [tar file](https://stackoverflow.com/questions/23935141/how-to-copy-docker-images-from-one-host-to-another-without-using-a-repository) to share to another host.
