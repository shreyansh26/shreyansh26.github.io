...
{% include image.liquid url="/assets/img/posts_images/gpt1/forwardlm.PNG" description="Forward LM probability modelling" %}

{% include image.liquid url="/assets/img/posts_images/gpt1/backwardlm.PNG" description="Backward LM probability modelling" %}
...
{% include image.liquid url="/assets/img/posts_images/gpt1/bilm.PNG" description="biLM probability modelling" %}
...
{% include image.liquid url="/assets/img/posts_images/gpt1/elmorepr.PNG" description="" %}
...
{% include image.liquid url="/assets/img/posts_images/gpt1/elmoeq.PNG" description="" %}
...
{% include image.liquid url="/assets/img/posts_images/gpt1/results.PNG" description="Results comparison of the baseline models with the ones used along with ELMo" %}
...
{% include image.liquid url="/assets/img/posts_images/gpt1/layercomp.PNG" description="Baseline vs ELMo last layer vs All the layers" %}
...
{% include image.liquid url="/assets/img/posts_images/gpt1/layerloc.PNG" description="" %}
...
{% include image.liquid url="/assets/img/posts_images/gpt1/contextcapture.PNG" description="biLM captures the context of the word 'play' effectively from the source sentences" %}
...
{% include image.liquid url="/assets/img/posts_images/gpt1/sampleeff.PNG" description="biLM captures the context of the word 'play' effectively from the source sentences" %}
